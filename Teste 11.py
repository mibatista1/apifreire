...
class TextAnalyzerApp:
    ...
    def preprocess_text(self, text):
        ...
        stop_words = set(stopwords.words('english'))  # Alterado para inglês
        stop_words.update({'a', 'the', 'of', 'and', 'to', 'in', 'that', 'it', 'is', 'for', 'on', 'with', 'as', 'was', 'at', 'by', 'an', 'be', 'this', 'which', 'or', 'from', 'has', 'are', 'have', 'not', 'was', 'will', 'but'})
